...
namespace PakExplorer.ViewModels
{
    public sealed class MainViewModel : ObservableObject
    {
        ...
        public ICommand DecryptPakCommand { get; }
        public ICommand SwapFileCommand { get; }
        ...
        public Pak CurrentPak
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(DecryptPakCommand));
            }
        }
        ...
        private async Task DecryptPakAsync()
        {
            ...
            if ((string)choice.Id == "yes")
            {
                ...
                var flyout = new Flyout()
                {
                    Content = new TextBlock { Text = $"Pak decrypted!" },
                    Placement = FlyoutPlacementMode.Bottom
                };
                flyout.ShowAt((FrameworkElement)Window.Current.Content);
        ...
        private async Task SwapFileAsync()
        {
            ...
            if (newFile != null)
            {
                ...
                using (var bufferStream = new MemoryStream())
                {
                    ...
                    var flyout = new Flyout()
                    {
                        Content = new TextBlock { Text = $"File replaced!" },
                        Placement = FlyoutPlacementMode.Bottom
                    };
                    flyout.ShowAt((FrameworkElement)Window.Current.Content);
                }
